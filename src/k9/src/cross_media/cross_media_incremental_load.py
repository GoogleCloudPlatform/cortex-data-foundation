...
"""
Cloud Composer DAG to incrementally load Cortex Cross Media views.

- Map all new campaigns to product hierarchies.
...
with DAG("cross_media_incremental_load",
         description="Cross-Media Incremental Matching DAG",
         default_args=default_args,
         schedule_interval="@daily",
         start_date=datetime(2022, 11, 2),
         catchup=False,
         max_active_runs=1,
         user_defined_macros={"initial_load": False}) as dag:
