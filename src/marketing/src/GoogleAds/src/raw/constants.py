...
SQL_TEMPLATE_DIR = Path(DAG_TEMPLATE_DIR, "sql")
SQL_TEMPLATE_FILE = Path(SQL_TEMPLATE_DIR, "source_to_raw_view_template.sql")
...
SQL_OUTPUT_DIR = Path(OUTPUT_DIR_FOR_RAW, "generated_view_sql")
