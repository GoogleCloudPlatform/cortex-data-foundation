...
/* This is a sample script showing how to directly use the Activities table that contains
...
SELECT
  ...
  COUNTIF(is_post_click_conversion) AS post_click_conversions,
  COUNTIF(is_post_view_conversion) AS post_view_conversions,
