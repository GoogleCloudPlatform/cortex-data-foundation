...
/* Sample script showing how to calculate KPIs at Ad Set and Placement level from daily aggregate
   table.
...
CROSS JOIN UNNEST(placement_details) AS placement_details
