...
_SOURCE_CONFIG = _PROJECT_CONFIG["marketing"]["DV360"]
...
SRC_PROJECT = _PROJECT_CONFIG["projectIdSource"]
CDC_DATASET = _SOURCE_CONFIG["datasets"]["cdc"]

POPULATE_TEST_DATA = _PROJECT_CONFIG["testData"]

SCHEMA_TARGET_FIELD = "ColumnName"
SCHEMA_BQ_DATATYPE_FIELD = "ColumnDataType"

BQ_LOCATION = _PROJECT_CONFIG["location"]
