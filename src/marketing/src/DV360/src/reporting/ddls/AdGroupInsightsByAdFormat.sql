...
/* Adgroup Insights breakdown by Adformat at Date level. */

SELECT
  Insights.date,
  Insights.youtube_ad_group_id,
  Insights.youtube_ad_format,
...
FROM `{{ project_id_src }}.{{ marketing_dv360_datasets_cdc }}.adgroup_insights_by_adformat` AS Insights
