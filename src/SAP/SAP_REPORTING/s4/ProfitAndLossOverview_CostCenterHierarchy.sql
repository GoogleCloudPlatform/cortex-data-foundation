...
SELECT
  ...
  CCParentText.SetName_SETNAME AS CCParentText,
  COALESCE(CCNodeText.SetName_SETNAME, CCText.Description_LTEXT) AS CCNodeText,
...
LEFT JOIN
  ...
  ON ProfitAndLoss.Client = CostCenters.mandt
