...
--mcha.BATCH_ID AS BatchID_BATCH_ID,
--mcha.XPCBT AS SingleUnitBatchIndicator_XPCBT,
--mcha.CREATION_DATETIME	AS CreatedOnTimestamp_CREATION_DATETIME,
--mcha.LASTCHANGE_DATETIME	AS LastChangeTimestamp_LASTCHANGE_DATETIME,
--mcha.STTPEC_SERTYPE	SerializationType_STTPEC_SERTYPE,
--mcha.STTPEC_PLANT	AS BatchProductionPlant_STTPEC_PLANT,
--mcha.STTPEC_SYNCTIME	AS SynchronizationTimeStamp_STTPEC_SYNCTIME,
--mcha.STTPEC_SYNCACT	AS SynchronizationActive_STTPEC_SYNCACT
FROM `{{ project_id_src }}.{{ dataset_cdc_processed_s4 }}.mcha` AS mcha
