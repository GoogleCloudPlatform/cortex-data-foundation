...
`{{ project_id_tgt }}.{{ dataset_reporting_tgt }}.stock_monthly_snapshots`( --noqa:disable=LT01
  mandt STRING,
  werks STRING,
  matnr STRING,
  charg STRING,
...
CALL `{{ project_id_tgt }}.{{ dataset_reporting_tgt }}.UpdateStockMonthlySnapshots`( --noqa:disable=LT02
{% if sql_flavour == 'ecc' -%}
