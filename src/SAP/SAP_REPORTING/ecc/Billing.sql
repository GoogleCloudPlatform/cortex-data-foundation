...
SELECT
  ...
  -- ##CORTEX-CUSTOMER If you prefer to use currency conversion,
  -- uncomment below
  ...
  -- COALESCE(AGGKONV.rebate * currency_decimal.CURRFIX, AGGKONV.rebate) * currency_conversion.UKURS AS RebateInTargetCurrency,
