...
FROM
  `{{ project_id_src }}.{{ dataset_cdc_processed_ecc }}.vbap` AS vbap
INNER JOIN
  `{{ project_id_src }}.{{ dataset_cdc_processed_ecc }}.vbup` AS vbup
  ON
...
INNER JOIN
  `{{ project_id_src }}.{{ dataset_cdc_processed_ecc }}.lips` AS lips
  ON
...
INNER JOIN
  `{{ project_id_src }}.{{ dataset_cdc_processed_ecc }}.vbak` AS vbak
  ON
